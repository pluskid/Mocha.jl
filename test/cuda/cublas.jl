function test_cublas(sys::System)
  ...
  x = rand(dims)
  x2 = similar(x)
  x_blob = Mocha.cudnn_make_pod_blob(Float64, dims...)
  x2_blob = Mocha.cudnn_make_pod_blob(Float64, dims...)
  copy!(x_blob, x)
  copy!(x2, x_blob)
  ...
  B = rand(6,7)
  C = rand(5,7)
  blob_A = Mocha.cudnn_make_pod_blob(Float64, 5,6)
  blob_B = Mocha.cudnn_make_pod_blob(Float64, 6,7)
  blob_C = Mocha.cudnn_make_pod_blob(Float64, 5,7)
