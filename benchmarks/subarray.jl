...
# |-----|----------------------|----------|----------|--------------|
# | 1   | "pool_with_subarray" | 10.5116  | 30.4342  | 10           |
# | 2   | "pool_with_iter"     | 0.345389 | 1.0      | 10           |
# | 3   | "pool_with_getidx"   | 1.99636  | 5.78003  | 10           |
################################################################################
...
df = compare([pool_with_subarray, pool_with_iter, pool_with_getidx], 10)
println("$df")
