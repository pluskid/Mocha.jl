const MAX_POOL_FWD_FLOAT = dlsym(Native.library, :max_pooling_fwd_float)
const MAX_POOL_FWD_DOUBLE = dlsym(Native.library, :max_pooling_fwd_double)
const MAX_POOL_BWD_FLOAT = dlsym(Native.library, :max_pooling_bwd_float)
const MAX_POOL_BWD_DOUBLE = dlsym(Native.library, :max_pooling_bwd_double)

const MEAN_POOL_FWD_FLOAT = dlsym(Native.library, :mean_pooling_fwd_float)
const MEAN_POOL_FWD_DOUBLE = dlsym(Native.library, :mean_pooling_fwd_double)
const MEAN_POOL_BWD_FLOAT = dlsym(Native.library, :mean_pooling_bwd_float)
const MEAN_POOL_BWD_DOUBLE = dlsym(Native.library, :mean_pooling_bwd_double)
